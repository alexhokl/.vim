...
if vim.fn.has("folding") == 1 then
	map("n", "<leader>c0", function()
		vim.o.foldlevel = 0
	end, "Collapses to level 1")
	map("n", "<leader>c1", function()
		vim.o.foldlevel = 1
	end, "Collapses to level 2")
	map("n", "<leader>c2", function()
		vim.o.foldlevel = 2
	end, "Collapses to level 3")
	map("n", "<leader>c3", function()
		vim.o.foldlevel = 3
	end, "Collapses to level 4")
	map("n", "<leader>c4", function()
		vim.o.foldlevel = 4
	end, "Collapses to level 5")
	map("n", "<leader>c5", function()
		vim.o.foldlevel = 5
	end, "Collapses to level 6")
	map("n", "<leader>c9", function()
		vim.o.foldlevel = 99
	end, "Expand all folds")
end
